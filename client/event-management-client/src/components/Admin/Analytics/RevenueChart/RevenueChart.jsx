...
const RevenueChart = () => {
	...
	return (
		<motion.div
			className='bg-[#510f90] bg-opacity-80 backdrop-filter backdrop-blur-lg shadow-lg rounded-xl p-6 border border-gray-700 mb-8'
		...
		>
			<div className='flex justify-between items-center mb-6'>
				...
				<select
					className='bg-white text-black rounded-md px-3 py-1 focus:outline-none focus:ring-2 focus:ring-blue-500'
