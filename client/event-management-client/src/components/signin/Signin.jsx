         ...
         <div className="rightbox koka">
            ...
            <div className="signininfo">
                <form>
                    ...
                    <label htmlFor="inname">YOUR EMAIL</label>
                    <input type="text" placeholder='Enter your mail' id='inname' onChange={(e)=>setEmail(e.target.value)}/>
                    </div>
                    <div className="inpassword">
                    <label htmlFor="inpassword">PASSWORD</label>
                    <input type="text" placeholder='Enter your password' id='inpassword' onChange={(e)=>setPassword(e.target.value)}/>
                    </div>
                    
                </form>
            </div>
            <div className="googleinbtn">
                <button className="simpsignin" onClick={handleLogin}>Sign In</button>
                <p>or</p>
